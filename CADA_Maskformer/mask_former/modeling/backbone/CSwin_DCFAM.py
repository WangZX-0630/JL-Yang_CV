...
class CSWinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=96, depth=[2,2,6,2], split_size = [3,5,7],
                 ...
                 drop_path_rate=0.6, hybrid_backbone=None, norm_layer=nn.LayerNorm, use_chk=False):
        ...
        self.conv_forU = Conv2d(192, 96, kernel_size=3, stride=1, padding=1, bias=True)
...
class D2SwinTransformer(CSWinTransformer, Backbone):
    def __init__(self, cfg, input_shape):
        ...
        split_size=[1,2,10,10], num_heads=[4,8,16,32], mlp_ratio=4., 
        )
