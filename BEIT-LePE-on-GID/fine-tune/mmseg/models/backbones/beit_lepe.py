...
#---------------------------将要从这个地方开始修改-----------------------------------------------------------------
    def forward(self, x, rel_pos_bias=None):
        ...
        #qkv = qkv.reshape(B, N, 3, self.num_heads, -1).permute(2, 0, 3, 1, 4) 原
...
class BEiT_LEPE(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=80, embed_dim=768, depth=12,
                 ...
                 use_abs_pos_emb=True, use_rel_pos_bias=False, use_shared_rel_pos_bias=False, use_lepe_pos_bias=False,
