...
import random
from Training.ptsemseg.utils import split_psp_dict
from Training.ptsemseg.models.td4_psp.pspnet_4p import pspnet_4p
import logging
import pdb
import os
...
class td4_psp(nn.Module):
    def __init__(self,
        ...
        self.psp1 = PyramidPooling(512 * self.expansion, norm_layer, self._up_kwargs, path_num=self.path_num // 2,
                                   pid=0)
        self.psp2 = PyramidPooling(512 * self.expansion, norm_layer, self._up_kwargs, path_num=self.path_num // 2,
                                   pid=1)
        self.psp3 = PyramidPooling(512 * self.expansion, norm_layer, self._up_kwargs, path_num=self.path_num // 2,
                                   pid=0)
        self.psp4 = PyramidPooling(512 * self.expansion, norm_layer, self._up_kwargs, path_num=self.path_num // 2,
                                   pid=1)
