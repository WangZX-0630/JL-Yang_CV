...
class pspnet_2p(nn.Module):
    ...
    def __init__(self,
        ...
        self.group1 = ConvBNReLU(2048, 512, norm_layer, ksize=3, pad=1, BNLU=False)
        self.group2 = ConvBNReLU(2048, 512, norm_layer, ksize=3, pad=1, BNLU=False)
    ...
    def pretrained_init(self):
        ...
        if self.teacher_model is not None:
            if os.path.isfile(self.teacher_model):
                ...
                backbone_state, psp_state, grp_state1, grp_state2, _, _, head_state, auxlayer_state = split_psp_state_dict(model_state,self.path_num)
