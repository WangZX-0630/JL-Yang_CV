...
from .customize import PyramidPooling, StripPooling, StripPooling2, \
    StripPooling2new, StripPooling4, StripPooling4cat, StripPooling4new
...
class SPHead(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer, up_kwargs): # SP
