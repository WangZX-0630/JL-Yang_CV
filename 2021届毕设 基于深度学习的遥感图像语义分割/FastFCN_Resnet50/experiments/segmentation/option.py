...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--jpu', type=str, default='JPU',
                            help='JPU name')
        ...
        parser.add_argument('--crop-size', type=int, default=780,
        ...
        parser.add_argument('--save_path', type=str, default='expRes50S512',
                            help='path to save information during train')
        ...
        parser.add_argument('--save-folder', type=str, default='Res50S1024fps',
                            help = 'path to save images')
        parser.add_argument('--model_path', type=str, default='expRes50S1024/model_best.pth.tar',
